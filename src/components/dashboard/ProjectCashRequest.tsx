...
interface ProjectCashRequestProps {
  project: any;
  cashRequests: any[];
  onAddCashRequest: (cashRequest: any) => void;
  onUpdateCashRequest: (id: any, cashRequest: any) => void;
  onDeleteCashRequest: (id: any) => void;
  onUpdateRequestStatus: (id: any, status: any, comments?: string) => void;
}

const ProjectCashRequest: React.FC<ProjectCashRequestProps> = ({
  project,
  cashRequests,
  onAddCashRequest,
  onUpdateCashRequest,
  ...
  const [showRequestForm, setShowRequestForm] = useState(false);  const [editingRequest, setEditingRequest] = useState<any>(null);
  ...
  const handleViewDetail = (cashRequest: any) => {
    setDetailModal({
      isOpen: true,
      cashRequest
    });
  ...
  const handleUpdateStatus = async (requestId: any, newStatus: any, comments: string = '') => {
